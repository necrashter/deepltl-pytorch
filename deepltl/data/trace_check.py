...
def run_trace_checker(formulas_file, traces_file, targets_file, log_file, sat_prob_file, polish, sem_desp_syn, per_size, validator, log_level, **kwargs):
...
if __name__ == '__main__':
    ...
    res, res_str = run_trace_checker(**vars(args))
    print(res_str, end='')
